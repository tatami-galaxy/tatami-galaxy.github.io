...
<figure>
  <img src="/images/ppo-grpo-credit-assignment.png" alt="Comparison of PPO token-level credit assignment using a value function and GAE with GRPO's uniform group-relative credit assignment.">
  <figcaption><strong>Figure 1.</strong> Difference in credit assignment in PPO and GRPO : token level vs uniform. Image generated by GPT 5.6 Sol.</figcaption>
</figure>
