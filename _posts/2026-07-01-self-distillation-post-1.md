...
<figure class="half">
  <img src="/images/ppo-token-level-credit-v5.png" alt="PPO uses a learned value function and generalized advantage estimation to assign different credit to individual tokens in a rollout.">
  <img src="/images/grpo-group-level-credit-v5.png" alt="GRPO compares terminal rewards across a group and assigns one group-relative advantage uniformly to every token in each rollout.">
