...
<figure>
  <img src="/images/ppo-grpo-credit-assignment.png" alt="Comparison of PPO token-level credit assignment using a value function and GAE with GRPO's uniform group-relative credit assignment." style="max-width: 850px; max-height: 550px; margin-left: auto; margin-right: auto;">
