...
and use GPT-4o [[31]](#ref-31) to approximately estimate these quantities. Lets utilize these metrics as well. Before that we need to decide on the choice of PI. Here are a few reasonable choices : 
