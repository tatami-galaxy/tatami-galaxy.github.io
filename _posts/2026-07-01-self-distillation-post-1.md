...
<figure>
  <img src="/images/ppo-grpo-credit-assignment.png" alt="Comparison of PPO token-level credit assignment using a value function and GAE with GRPO's uniform group-relative credit assignment." style="width: auto; max-width: 650px; height: auto; max-height: 700px; margin-left: auto; margin-right: auto;">
