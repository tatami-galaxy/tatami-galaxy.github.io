...
<figure>
  <img src="/images/ppo-grpo-credit-assignment.png" alt="Comparison of PPO token-level credit assignment using a value function and GAE with GRPO's uniform group-relative credit assignment." style="width: auto; max-width: 750px; height: auto; max-height: 650px; margin-left: auto; margin-right: auto;">
