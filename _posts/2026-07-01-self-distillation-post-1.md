...
<figure>
  <img src="/images/ppo-grpo-credit-assignment.png" alt="Comparison of PPO token-level credit assignment using a value function and GAE with GRPO's uniform group-relative credit assignment." style="width: 100%; max-width: 650px; margin-left: auto; margin-right: auto;">
