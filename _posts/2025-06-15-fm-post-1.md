...
To this end, we can randomly assign an $$x_1$$ to an $$x_0$$ and regress the resulting flow (design choice 7). 

<img src='/images/FM_random_pair.png' alt='missing' width="600" height="400"/>
...
We can now attempt to find an optimal $$\psi_t(x|x_1)$$ (and therefore $$u_t(x|x_1)$$) as follows. From (19) and (20) :
...
where the constraints are the result of design choice 7.

Thich problem can be solved using the [Euler-Lagrange equations](https://en.wikipedia.org/wiki/Euler%E2%80%93Lagrange_equation).
