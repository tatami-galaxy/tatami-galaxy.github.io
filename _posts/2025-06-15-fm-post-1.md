...
We will constrain flows and velocity fields to be $$C^r([0,1] \times R^d, R^d)$$ diffeomorphisms. 

This constraint allows us to comment on the existence and uniqueness of solutions $$\psi_t(x) to equation (1). 
