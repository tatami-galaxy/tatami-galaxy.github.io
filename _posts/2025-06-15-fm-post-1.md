...
$$(p_t^*, u_t^*) = \underset{p_t, u_t}{\operatorname{argmin}}\int_{0}^{1}\int ||u_t(x)||^2p_t(x)dxdt, \tag{18}$$
...
TODO : interpretation of $$u_t(x)$$ as the least-squares approximation to $$u_t(X_t|X_1)$$ given $$X_t = x$$.
