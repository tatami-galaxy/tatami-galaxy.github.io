...
To guarantee a solution until $$t = 1$$ for all $$x \in R^d$$, we must make an additional assumption beyond local Lipschitzness. This is the integrability assumption : 
