...
where $$J$$ is the Jacobian. This means that in order for us to compute (4), $$\psi_t$$ has to be invertible, and the Jacobian of its inverse must exist. This can be enforced in a principled way in terms of diffeomorphisms. 
