...
Let $$C^r(R^m, R^n)$$ denote the collection of functions $$f : R^m \rightarrow R^n$$ with continuous partial derivates of order $$r$$. $$C^r$$ diffeomorphism is a class of invertible functions with $$\psi \in C^r(R^d, R^d)$$ and $$\psi^{-1} \in C^r(R^d, R^d)$$. We will constrain flows and velocity fields to be $$C^r([0,1] \times R^d, R^d)$$ diffeomorphisms. 
